...
#include "neigh_table_shrink_tuner.h"
#include "neigh_table_shrink_tuner.skel.h"
#include "neigh_table_shrink_tuner.skel.legacy.h"
#include "neigh_table_shrink_tuner.skel.nobtf.h"


struct neigh_table_shrink_tuner_bpf *skel;
...
{
	int err = bpftuner_bpf_init(neigh_table_shrink, tuner, NULL);
